<!DOCTYPE html>
<html lang="en">
//Giventus Marco Victorio Handojo
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    ...
    <title>Pemrograman Web - UTS</title>
</head>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container">
            ...
            <div class="d-flex justify-content-end">
                ...
                <button class="btn btn-warning ms-2" type="button" href="./loginPage.php">
                    <a class="text-light" style="text-decoration: none" href="./page/adminLoginPage.php">Admin</a>
                </button>
            </div>
        </div>
    </nav>
        ...
        <div class="container min-vh-100 d-flex align-items-center justify-content-center">
            <div class="pt-5 mt-4">
                <h2 class="text-center align-middle text-white"><b class="bg-dark">
                        Selamat Datang di Perpustakaan Kami - PAW A - KELOMPOK H</b></h2>
            </div>
        </div>
    </div>
