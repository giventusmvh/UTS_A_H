...
0.19);">
        <div style="display: flex; justify-content:space-between">
            ...
            <a href="../page/tambahBeritaPage.php" class="btn btn-success">Tambah berita</a>
        </div>
    ...
    if (mysqli_num_rows($query) == 0) {
        ...
        <div class="card ms-3 mb-5" style="width: 18rem; display:flex">
            ...
            <div class="card-body">
                ...
                <a href="../page/editBeritaPage.php?id=' . $data ['id'] . '" onClick="return confirm ( \'Ingin edit berita ini?\')" class="btn btn-sm btn-primary">EDIT
                </a>
                <a href="../process/deleteBeritaProcess.php?id=' . $data ['id'] . '" onClick="return confirm ( \'Are you sure want to delete this data?\')"class="btn btn-sm btn-danger">DELETE
                </a>
            </div>
        </div>
