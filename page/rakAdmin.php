...
0.19);">
    <div style="display: flex; justify-content:space-between">
            <h4>RAK BUKU</h4>
            <a href="../page/tambahRakPage.php" class="btn btn-success">Tambah Rak</a>
        </div>
    <hr>
...
<a href="../page/editRakPage.php?id=' . $data ['id'] . '" onClick="return confirm ( \'Are you sure want to update this data?\')"class="btn btn-sm btn-success">EDIT
</a>
<a href="../process/deleteRakProcess.php?id=' . $data ['id'] . '" onClick="return confirm ( \'Are you sure want to delete this data?\')"class="btn btn-sm btn-danger">DELETE
</a>
</td>
</tr>';
                    $no++;
